...
<body>
    <div id="container">
        ...
        <nav id="main_menu">
            <ul>
                <li><a href="{{ URL::to('article') }}">Aktualności</a></li>
                <li><a href="{{ URL::to('file') }}">Pliki</a></li>
                <li><a href="{{ URL::to('team') }}">Kadra</a></li>
                <li><a href="{{ URL::to('notice') }}">Ogłoszenia</a></li>
                <li><a href="{{ URL::to('photo') }}">Galeria</a></li>
